...
function FilterTableComponent() {
  ...
  useEffect(()=>{fetch(`http://localhost:8080/api/messageAdmin/${localStorage.getItem('username')}`,{  
    method: 'GET',
    headers: {
 ...
 list3.sortBy(function(o){ return o.dateMessage });
 
    return (
      <div>
        <Table columns={columns} data={list3} />
        <div>{
                 exampleModal?
                    <Modal
